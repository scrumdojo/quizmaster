...
# Bootstraps the exploratory-testing agent exercise on a fresh machine.
#
...
#
#   cd agent-exercise && ./install.sh        (or: pnpm setup)
...
echo "  pnpm run-tour \"...what you want it to explore...\""
